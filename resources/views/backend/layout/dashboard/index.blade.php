                    ...
                    <div class="row row-bordered g-0">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="gap-3 p-4 d-flex px-xxl-4 px-lg-2 gap-xxl-3 gap-lg-1 justify-content-between">
                          <div class="d-flex">
                            <div class="me-2">
                              <span class="p-2 badge bg-label-primary"><i class="bx bx-dollar text-primary"></i></span>
                            </div>
                          ...
                          <div class="d-flex">
                            <div class="me-2">
                              <span class="p-2 badge bg-label-info"><i class="bx bx-wallet text-info"></i></span>
                            </div>
                            <div class="d-flex flex-column">
                              <small>2021</small>
