      ...
      <section class="live--auctions--area">
        <div class="container">
          ...
          <div class="row">
            ...
            <div
              class="text-center col-12 mt_70"
              data-aos="fade-in"
              data-aos-duration="1500"
              data-aos-delay="100"
            >
