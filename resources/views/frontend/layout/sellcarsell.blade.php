                                ...
                                <div class="col-lg-4 mt_25">
                                    ...
                                    <div class="radio--box">
                                        ...
                                        <div class="radio--options">
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="locate-saudi" type="radio" name="country" value="asd"
                                                    required />
                                            ...
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="locate-arab" type="radio" name="country" value="asddsd"
                                                    required />
                                ...
                                <div class="col-md-4 mt_25">
                                    ...
                                    <div class="radio--box">
                                        ...
                                        <div class="radio--options">
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="audi-car" type="radio" required />
                                                <label for="audi-car">
                                                    Audi R817
                                                    <svg width="20" height="20" viewBox="0 0 20 20"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="toyota" type="radio" required />
                                                <label for="toyota">
                                                    Toyota Supra
                                                    <svg width="20" height="20" viewBox="0 0 20 20"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-md-4 mt_25">
                                    ...
                                    <div class="radio--box">
                                        ...
                                        <div class="radio--options">
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="named-yes" type="radio" required />
                                                <label for="named-yes">
                                                    Yes
                                                    <svg width="20" height="20" viewBox="0 0 20 20"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="named-no" type="radio" required />
                                                <label for="named-no">
                                                    No
                                                    <svg width="20" height="20" viewBox="0 0 20 20"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-12 mt_25">
                                    ...
                                    <div class="radio--box">
                                        ...
                                        <div class="radio--options">
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="minimum-yes" type="radio" required />
                                            ...
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="minimum-no" type="radio" required />
